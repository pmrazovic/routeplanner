...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Example problem with 61 vehicles, 2 depots, and 8 vehicles
        ...
        // 20 random customers with high priority
        for (int i = 0; i < 20; i++) {
            customerList.get(ran.nextInt(61)).setPriority(2);
        }

        // Splitting vehicles among depots
        ...
        // Dummy vehicle without constraints
        ...
        // Update frame whenever a new best solution is found
